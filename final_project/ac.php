...
$qrl1="INSERT INTO admin1 VALUES('$Library_Id','$Name','$Email',$Phone,'$Date_of_birth','$Gender','$Password','$Image')";
...
<body>
    ...
    <section class="sec1">
        ...
        <input style="width: 77%;" type="email" name="email" placeholder="abcde@gmail.com" require> <br>
        ...
        <select id="cars" name="gen">
          ...
          <input style="width: 75%;" type="password" required name="pass"><br>
     ...
     <input class="aa" style="padding: 10px; font-size: 17px;margin-top: 40px; width: 50%;text-align: center;margin-left: 147px;background-color: seagreen;" type="submit" value="Sign In As an Admin" name="submit">
     </form>

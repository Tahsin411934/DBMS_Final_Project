    ...
    <div class="div1">
        ...
        <div class="header-2">
            <nav class="navbar">
               ...
               <li><a href="Add_book.php">Best Selling Book</a></li>   
               <li><a href="Add_book.php">Islamic Book</a></li> 
               <div class="dropdown">
  <li class="dropbtn">Place Order
  <div class="dropdown-content">
  <a href="Add_book.php">Fiction Book</a>
  <a href="Add_book.php">History Book</a>
  <a href="Add_book.php">Islamic Book</a>
  </div>
</div></li>
